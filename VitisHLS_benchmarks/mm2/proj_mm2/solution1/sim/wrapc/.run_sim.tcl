...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mm2.autotvin.dat"
	set constFileTvOut       "mm2.autotvout.dat"
	set constFileHdlTvIn     "mm2.autohdltvin.dat"
	set constFileHdlTvOut    "mm2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
