...
define dso_local void @mm2(float*, float*, float*, float*, float, float) #0 {
  ...
  %23 = alloca [256 x float], align 16
  ...
  %27 = bitcast float* %17 to i8*
  call void @llvm.var.annotation(i8* %27, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 33)
  %28 = load float, float* %11, align 4
  store float %28, float* %17, align 4
  %29 = bitcast float* %18 to i8*
  call void @llvm.var.annotation(i8* %29, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 35)
  %30 = load float, float* %12, align 4
  store float %30, float* %18, align 4
  %31 = bitcast float** %19 to i8*
  call void @llvm.var.annotation(i8* %31, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 38)
  %32 = load float*, float** %7, align 8
  store float* %32, float** %19, align 8
  %33 = bitcast float** %20 to i8*
  call void @llvm.var.annotation(i8* %33, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 40)
  %34 = load float*, float** %8, align 8
  store float* %34, float** %20, align 8
  %35 = bitcast float** %21 to i8*
  call void @llvm.var.annotation(i8* %35, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 42)
  %36 = load float*, float** %9, align 8
  store float* %36, float** %21, align 8
  %37 = bitcast float** %22 to i8*
  call void @llvm.var.annotation(i8* %37, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 44)
  %38 = load float*, float** %10, align 8
  store float* %38, float** %22, align 8
  %39 = bitcast [256 x float]* %23 to i8*
  call void @llvm.var.annotation(i8* %39, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 46)
  %40 = bitcast i32* %24 to i8*
  call void @llvm.var.annotation(i8* %40, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 48)
  %41 = bitcast i32* %25 to i8*
  call void @llvm.var.annotation(i8* %41, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 49)
  %42 = bitcast i32* %26 to i8*
  call void @llvm.var.annotation(i8* %42, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i32 50)
...
; <label>:50:                                     ; preds = %47
  ...
  %57 = getelementptr inbounds [256 x float], [256 x float]* %23, i64 0, i64 %56
...
; <label>:96:                                     ; preds = %93
  ...
  %103 = getelementptr inbounds [256 x float], [256 x float]* %23, i64 0, i64 %102
  ...
  %115 = load float*, float** %22, align 8
  ...
  %122 = getelementptr inbounds float, float* %115, i64 %121
