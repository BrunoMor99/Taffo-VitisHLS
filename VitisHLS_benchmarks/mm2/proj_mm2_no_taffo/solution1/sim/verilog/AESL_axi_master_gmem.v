...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.mm2.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.mm2.autotvout_gmem.dat"
...
parameter gmem_mem_depth = 32'd 1024;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/bruno/Desktop/benchmarks/mm2/proj_mm2_no_taffo/solution1/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/bruno/Desktop/benchmarks/mm2/proj_mm2_no_taffo/solution1/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
