set moduleName covariance_Pipeline_VITIS_LOOP_41_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {covariance_Pipeline_VITIS_LOOP_41_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "data","offset": { "type": "dynamic","port_name": "data","bundle": "control"},"direction": "READWRITE"},{"cName": "cov","offset": { "type": "dynamic","port_name": "cov","bundle": "control"},"direction": "READWRITE"},{"cName": "mean","offset": { "type": "dynamic","port_name": "mean","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "mean", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mean sc_in sc_lv 64 signal 1 } 
	{ data sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mean", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "mean", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mean { ap_none {  { mean in_data 0 64 } } }
