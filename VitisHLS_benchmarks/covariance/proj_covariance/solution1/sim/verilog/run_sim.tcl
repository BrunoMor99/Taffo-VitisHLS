...
if {[file isfile covariance.autotvin.dat]} {
	file delete -force covariance.autotvin.dat
}

if {[file isfile covariance.autotvout.dat]} {
	file delete -force covariance.autotvout.dat
}
