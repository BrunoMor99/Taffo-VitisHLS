...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.covariance.autotvin_gmem.dat"
         "c.covariance.autotvin_data.dat"
         "c.covariance.autotvin_cov.dat"
         "c.covariance.autotvin_mean.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.covariance.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
