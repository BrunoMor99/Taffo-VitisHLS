...
`define AUTOTB_DUT      covariance
`define AUTOTB_DUT_INST AESL_inst_covariance
`define AUTOTB_TOP      apatb_covariance_top
`define AUTOTB_LAT_RESULT_FILE "covariance.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "covariance.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_covariance_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 10.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_data 1
`define AESL_DEPTH_cov 1
`define AESL_DEPTH_mean 1
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.covariance.autotvin_gmem.dat"
`define AUTOTB_TVIN_data_out_wrapc  "../tv/rtldatafile/rtl.covariance.autotvin_data.dat"
`define AUTOTB_TVIN_cov_out_wrapc  "../tv/rtldatafile/rtl.covariance.autotvin_cov.dat"
`define AUTOTB_TVIN_mean_out_wrapc  "../tv/rtldatafile/rtl.covariance.autotvin_mean.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.covariance.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.covariance.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 18809;
parameter LENGTH_cov = 1;
parameter LENGTH_data = 1;
parameter LENGTH_gmem = 528;
parameter LENGTH_mean = 1;
...
reg end_cov;
reg [31:0] size_cov;
reg [31:0] size_cov_backup;
reg end_mean;
reg [31:0] size_mean;
reg [31:0] size_mean_backup;
