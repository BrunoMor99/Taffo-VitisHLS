set moduleName syr2k_Pipeline_VITIS_LOOP_52_3_VITIS_LOOP_54_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {syr2k_Pipeline_VITIS_LOOP_52_3_VITIS_LOOP_54_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 2}  }
	{ i_cast1 int 4 regular  }
	{ B int 64 regular  }
	{ A int 64 regular  }
	{ indvars_iv79 int 5 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"},{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "C","offset": { "type": "dynamic","port_name": "C","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "i_cast1", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "B", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "A", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "indvars_iv79", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ i_cast1 sc_in sc_lv 4 signal 1 } 
	{ B sc_in sc_lv 64 signal 2 } 
	{ A sc_in sc_lv 64 signal 3 } 
	{ indvars_iv79 sc_in sc_lv 5 signal 4 } 
	{ zext_ln52 sc_in sc_lv 9 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "i_cast1", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "i_cast1", "role": "default" }} , 
 	...
 	{ "name": "indvars_iv79", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "indvars_iv79", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "322", "Max" : "5442"}
	, {"Name" : "Interval", "Min" : "322", "Max" : "5442"}
]}
...
set Spec2ImplPortList { 
	...
	i_cast1 { ap_none {  { i_cast1 in_data 0 4 } } }
	B { ap_none {  { B in_data 0 64 } } }
	A { ap_none {  { A in_data 0 64 } } }
	indvars_iv79 { ap_none {  { indvars_iv79 in_data 0 5 } } }
