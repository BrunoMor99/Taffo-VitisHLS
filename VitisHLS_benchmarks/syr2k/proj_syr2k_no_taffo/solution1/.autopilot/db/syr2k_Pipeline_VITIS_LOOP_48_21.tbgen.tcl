set moduleName syr2k_Pipeline_VITIS_LOOP_48_21
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {syr2k_Pipeline_VITIS_LOOP_48_21}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 2}  }
	{ indvars_iv77 int 5 regular  }
	{ or_ln50 int 8 regular  }
	{ C int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"},{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "C","offset": { "type": "dynamic","port_name": "C","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "or_ln50", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ indvars_iv77 sc_in sc_lv 5 signal 1 } 
	{ or_ln50 sc_in sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "or_ln50", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "or_ln50", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "32", "Max" : "272"}
	, {"Name" : "Interval", "Min" : "32", "Max" : "272"}
]}
...
set Spec2ImplPortList { 
	...
	or_ln50 { ap_none {  { or_ln50 in_data 0 8 } } }
