set moduleName syr2k_Pipeline_VITIS_LOOP_52_3_VITIS_LOOP_54_44
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {syr2k_Pipeline_VITIS_LOOP_52_3_VITIS_LOOP_54_44}
...
set C_modelArgList {
	...
	{ B int 64 regular  }
	{ A int 64 regular  }
	{ indvars_iv75 int 5 regular  }
	{ zext_ln52_2 int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"},{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "C","offset": { "type": "dynamic","port_name": "C","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "tmp_9", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "B", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "A", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "indvars_iv75", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln52_2", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_9 sc_in sc_lv 4 signal 1 } 
	{ B sc_in sc_lv 64 signal 2 } 
	{ A sc_in sc_lv 64 signal 3 } 
	{ indvars_iv75 sc_in sc_lv 5 signal 4 } 
	{ zext_ln52_2 sc_in sc_lv 9 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_9", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "tmp_9", "role": "default" }} , 
 	...
 	{ "name": "indvars_iv75", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "indvars_iv75", "role": "default" }} , 
 	{ "name": "zext_ln52_2", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "zext_ln52_2", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "962", "Max" : "6082"}
	, {"Name" : "Interval", "Min" : "962", "Max" : "6082"}
]}
...
set Spec2ImplPortList { 
	...
	tmp_9 { ap_none {  { tmp_9 in_data 0 4 } } }
	B { ap_none {  { B in_data 0 64 } } }
	A { ap_none {  { A in_data 0 64 } } }
	indvars_iv75 { ap_none {  { indvars_iv75 in_data 0 5 } } }
	zext_ln52_2 { ap_none {  { zext_ln52_2 in_data 0 9 } } }
