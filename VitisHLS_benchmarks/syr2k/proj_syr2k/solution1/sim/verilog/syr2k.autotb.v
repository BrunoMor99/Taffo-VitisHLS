...
`define AUTOTB_DUT      syr2k
`define AUTOTB_DUT_INST AESL_inst_syr2k
`define AUTOTB_TOP      apatb_syr2k_top
`define AUTOTB_LAT_RESULT_FILE "syr2k.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "syr2k.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_syr2k_top
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.syr2k.autotvin_gmem.dat"
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.syr2k.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.syr2k.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "../tv/rtldatafile/rtl.syr2k.autotvin_C.dat"
`define AUTOTB_TVIN_alpha_out_wrapc  "../tv/rtldatafile/rtl.syr2k.autotvin_alpha.dat"
`define AUTOTB_TVIN_beta_out_wrapc  "../tv/rtldatafile/rtl.syr2k.autotvin_beta.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.syr2k.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.syr2k.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 94555;
parameter LENGTH_A = 1;
parameter LENGTH_B = 1;
parameter LENGTH_C = 1;
parameter LENGTH_alpha = 1;
parameter LENGTH_beta = 1;
parameter LENGTH_gmem = 768;
