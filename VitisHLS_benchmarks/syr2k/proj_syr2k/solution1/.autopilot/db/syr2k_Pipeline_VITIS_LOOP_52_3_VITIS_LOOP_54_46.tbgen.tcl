...
set C_modelArgList {
	...
	{ tmp_15 int 4 regular  }
	{ B int 64 regular  }
	{ A int 64 regular  }
	{ bound288 int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"},{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "C","offset": { "type": "dynamic","port_name": "C","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "tmp_15", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "B", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "A", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "bound288", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_15 sc_in sc_lv 4 signal 1 } 
	{ B sc_in sc_lv 64 signal 2 } 
	{ A sc_in sc_lv 64 signal 3 } 
	{ bound288 sc_in sc_lv 9 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_15", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "tmp_15", "role": "default" }} , 
 	...
 	{ "name": "bound288", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "bound288", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32ns_45_1_1_U63", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32s_48_1_1_U64", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32ns_45_1_1_U65", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32s_48_1_1_U66", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1218", "Max" : "6082"}
	, {"Name" : "Interval", "Min" : "1218", "Max" : "6082"}
]}
...
set Spec2ImplPortList { 
	...
	tmp_15 { ap_none {  { tmp_15 in_data 0 4 } } }
	B { ap_none {  { B in_data 0 64 } } }
	A { ap_none {  { A in_data 0 64 } } }
	bound288 { ap_none {  { bound288 in_data 0 9 } } }
