...
set C_modelArgList {
	...
	{ indvars_iv81_cast5 int 4 regular  }
	{ B int 64 regular  }
	{ A int 64 regular  }
	{ indvars_iv79 int 5 regular  }
	{ bound int 9 regular  }
	{ p_cast21 int 32 regular  }
	{ C int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"},{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"},{"cName": "C","offset": { "type": "dynamic","port_name": "C","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "indvars_iv81_cast5", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "p_cast21", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ indvars_iv81_cast5 sc_in sc_lv 4 signal 1 } 
	{ B sc_in sc_lv 64 signal 2 } 
	{ A sc_in sc_lv 64 signal 3 } 
	{ indvars_iv79 sc_in sc_lv 5 signal 4 } 
	{ bound sc_in sc_lv 9 signal 5 } 
	{ p_cast21 sc_in sc_lv 32 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "indvars_iv81_cast5", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "indvars_iv81_cast5", "role": "default" }} , 
 	...
 	{ "name": "bound", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "bound", "role": "default" }} , 
 	{ "name": "p_cast21", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_cast21", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32ns_45_1_1_U8", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32s_48_1_1_U9", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32ns_45_1_1_U10", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32s_48_1_1_U11", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "306", "Max" : "5170"}
	, {"Name" : "Interval", "Min" : "306", "Max" : "5170"}
]}
...
set Spec2ImplPortList { 
	...
	indvars_iv81_cast5 { ap_none {  { indvars_iv81_cast5 in_data 0 4 } } }
	B { ap_none {  { B in_data 0 64 } } }
	A { ap_none {  { A in_data 0 64 } } }
	indvars_iv79 { ap_none {  { indvars_iv79 in_data 0 5 } } }
	bound { ap_none {  { bound in_data 0 9 } } }
	p_cast21 { ap_none {  { p_cast21 in_data 0 32 } } }
