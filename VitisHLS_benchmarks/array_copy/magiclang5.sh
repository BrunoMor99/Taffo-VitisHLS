...
input_files="${path}/proj_${benchmark_name}/solution1/.autopilot/db/a.g.ld.5.gdce.bc"
echo $input_files
set -x
${CLANG} \
  $opts -O0 \
...
cp "${path}/intermediate/a.g.ld.5.gdce.bc" "${path}/proj_${benchmark_name}/solution1/.autopilot/db/a.g.ld.6.user.bc"
