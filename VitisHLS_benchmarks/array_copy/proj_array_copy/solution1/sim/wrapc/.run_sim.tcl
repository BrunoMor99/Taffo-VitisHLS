...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "array_copy.autotvin.dat"
	set constFileTvOut       "array_copy.autotvout.dat"
	set constFileHdlTvIn     "array_copy.autohdltvin.dat"
	set constFileHdlTvOut    "array_copy.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
