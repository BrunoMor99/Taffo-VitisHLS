...
if {[file isfile array_copy.autotvin.dat]} {
	file delete -force array_copy.autotvin.dat
}

if {[file isfile array_copy.autotvout.dat]} {
	file delete -force array_copy.autotvout.dat
}
