...
`define AUTOTB_DUT      array_copy
`define AUTOTB_DUT_INST AESL_inst_array_copy
`define AUTOTB_TOP      apatb_array_copy_top
`define AUTOTB_LAT_RESULT_FILE "array_copy.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "array_copy.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_array_copy_top
...
`define AUTOTB_TVIN_y  "../tv/cdatafile/c.array_copy.autotvin_y.dat"
`define AUTOTB_TVIN_alpha  "../tv/cdatafile/c.array_copy.autotvin_alpha.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.array_copy.autotvin_y.dat"
`define AUTOTB_TVIN_alpha_out_wrapc  "../tv/rtldatafile/rtl.array_copy.autotvin_alpha.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.array_copy.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.array_copy.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 77;
parameter LENGTH_alpha = 1;
parameter LENGTH_gmem = 16;
