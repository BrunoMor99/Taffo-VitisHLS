set moduleName array_copy_Pipeline_VITIS_LOOP_54_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {array_copy_Pipeline_VITIS_LOOP_54_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ p_cast_cast int 62 regular  }
	{ ys_u5_27fixp int 28 regular {array 16 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "y","offset": { "type": "dynamic","port_name": "y","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "ys_u5_27fixp", "interface" : "memory", "bitwidth" : 28, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ ys_u5_27fixp_address0 sc_out sc_lv 4 signal 2 } 
	{ ys_u5_27fixp_ce0 sc_out sc_logic 1 signal 2 } 
	{ ys_u5_27fixp_q0 sc_in sc_lv 28 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ys_u5_27fixp_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "ys_u5_27fixp", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.uitofp_32ns_32_2_no_dsp_1_U15", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	ys_u5_27fixp { ap_memory {  { ys_u5_27fixp_address0 mem_address 1 4 }  { ys_u5_27fixp_ce0 mem_ce 1 1 }  { ys_u5_27fixp_q0 in_data 0 28 } } }
}
