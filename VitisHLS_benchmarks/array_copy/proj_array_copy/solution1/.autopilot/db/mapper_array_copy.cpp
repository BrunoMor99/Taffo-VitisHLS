...
using hls::sim::Byte;
extern "C" void array_copy(Byte<4>*, int, float);
extern "C" void apatb_array_copy_hw(volatile void * __xlx_apatb_param_y, float __xlx_apatb_param_alpha) {
...
__xlx_y__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_y)[i]);
  ...
  // DUT call
  array_copy(__xlx_y__tmp_vec.data(), __xlx_offset_byte_param_y, __xlx_apatb_param_alpha);
