...
define dso_local void @array_copy(float*, float*, float*) #0 !taffo.start !2 !taffo.funinfo !3 {
  ...
  %10 = alloca [16 x float], align 16, !taffo.target !4, !taffo.info !5
  ...
  %13 = bitcast [16 x float]* %10 to i8*, !taffo.target !4, !taffo.info !8
...
; <label>:20:                                     ; preds = %17
  ...
  %28 = getelementptr inbounds [16 x float], [16 x float]* %10, i64 0, i64 %27, !taffo.target !4, !taffo.info !8
  store float %25, float* %28, align 4, !taffo.target !4, !taffo.info !8
  br label %29
...
; <label>:36:                                     ; preds = %33
  ...
  %39 = getelementptr inbounds [16 x float], [16 x float]* %10, i64 0, i64 %38, !taffo.target !4, !taffo.info !8
  %40 = load float, float* %39, align 4, !taffo.target !4, !taffo.info !8
  %41 = load float, float* %12, align 4, !taffo.info !8
  %42 = fmul float %40, %41, !taffo.info !8
  %43 = load i32, i32* %8, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds [16 x float], [16 x float]* %11, i64 0, i64 %44, !taffo.target !7, !taffo.info !8
  store float %42, float* %45, align 4, !taffo.target !7, !taffo.info !8
  br label %46
...
; <label>:53:                                     ; preds = %50
  ...
  %56 = getelementptr inbounds [16 x float], [16 x float]* %11, i64 0, i64 %55, !taffo.target !7, !taffo.info !8
  %57 = load float, float* %56, align 4, !taffo.target !7, !taffo.info !8
  %58 = load float*, float** %5, align 8
  %59 = load i32, i32* %8, align 4
  %60 = sext i32 %59 to i64
  %61 = getelementptr inbounds float, float* %58, i64 %60
  store float %57, float* %61, align 4, !taffo.target !7, !taffo.info !8
  br label %62
...
!6 = !{double 0.000000e+00, double 1.200000e+01}
!7 = !{!"ys"}
