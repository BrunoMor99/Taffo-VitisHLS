...
define dso_local void @array_copy(float*, float*, float*) #0 !taffo.start !10 !taffo.funinfo !11 {
  ...
  %10 = alloca [16 x float], align 16, !taffo.info !20, !taffo.target !23
  %11 = alloca [16 x float], align 16, !taffo.info !20, !taffo.target !24
  %12 = alloca float, align 4, !taffo.info !25
  store float* %0, float** %4, align 8
  store float* %1, float** %5, align 8
  store float* %2, float** %6, align 8
  store i32 16, i32* %7, align 4
  %13 = bitcast [16 x float]* %10 to i8*, !taffo.info !28, !taffo.target !23
  %14 = bitcast [16 x float]* %11 to i8*, !taffo.info !28, !taffo.target !24
  %15 = bitcast float* %12 to i8*, !taffo.info !29
  store float 5.000000e+00, float* %12, align 4, !taffo.info !30
  br label %16
...
; <label>:20:                                     ; preds = %17
  ...
  %23 = sext i32 %22 to i64, !taffo.info !31
  ...
  %27 = sext i32 %26 to i64, !taffo.info !31
  %28 = getelementptr inbounds [16 x float], [16 x float]* %10, i64 0, i64 %27, !taffo.info !33, !taffo.target !23
  store float %25, float* %28, align 4, !taffo.info !30, !taffo.target !23
  br label %29

; <label>:29:                                     ; preds = %20
  %30 = load i32, i32* %8, align 4, !taffo.info !18
  %31 = add nsw i32 %30, 1, !taffo.info !35
...
; <label>:36:                                     ; preds = %33
  ...
  %39 = getelementptr inbounds [16 x float], [16 x float]* %10, i64 0, i64 %38, !taffo.info !33, !taffo.target !23
  %40 = load float, float* %39, align 4, !taffo.info !39, !taffo.target !23
  %41 = load float, float* %12, align 4, !taffo.info !40
  %42 = fmul float %40, %41, !taffo.info !41
  %43 = load i32, i32* %8, align 4, !taffo.info !18
  %44 = sext i32 %43 to i64, !taffo.info !37
  %45 = getelementptr inbounds [16 x float], [16 x float]* %11, i64 0, i64 %44, !taffo.info !41, !taffo.target !24
  store float %42, float* %45, align 4, !taffo.info !30, !taffo.target !24
  br label %46

; <label>:46:                                     ; preds = %36
  %47 = load i32, i32* %8, align 4, !taffo.info !18
  %48 = add nsw i32 %47, 1, !taffo.info !42
...
; <label>:53:                                     ; preds = %50
  ...
  %55 = sext i32 %54 to i64, !taffo.info !44
  %56 = getelementptr inbounds [16 x float], [16 x float]* %11, i64 0, i64 %55, !taffo.info !41, !taffo.target !24
  %57 = load float, float* %56, align 4, !taffo.info !41, !taffo.target !24
  %58 = load float*, float** %5, align 8, !taffo.info !14
  %59 = load i32, i32* %8, align 4, !taffo.info !18
  %60 = sext i32 %59 to i64, !taffo.info !44
  %61 = getelementptr inbounds float, float* %58, i64 %60, !taffo.info !14
  store float %57, float* %61, align 4, !taffo.info !30, !taffo.target !24
  br label %62

; <label>:62:                                     ; preds = %53
  %63 = load i32, i32* %8, align 4, !taffo.info !18
  %64 = add nsw i32 %63, 1, !taffo.info !46
...
define dso_local i32 @main(i32, i8**) #0 !taffo.funinfo !49 {
  ...
  %16 = alloca float, align 4, !taffo.info !52
  %17 = alloca float, align 4, !taffo.info !50
...
; <label>:48:                                     ; preds = %56, %47
  %49 = load i32, i32* %12, align 4, !taffo.info !44
  %50 = icmp slt i32 %49, 16, !taffo.info !12
  br i1 %50, label %51, label %59

; <label>:51:                                     ; preds = %48
  %52 = load float, float* %17, align 4, !taffo.info !50
  %53 = load i32, i32* %12, align 4, !taffo.info !44
  %54 = sext i32 %53 to i64, !taffo.info !31
  %55 = getelementptr inbounds float, float* %26, i64 %54, !taffo.info !14
  store float %52, float* %55, align 4
  br label %56

; <label>:56:                                     ; preds = %51
  %57 = load i32, i32* %12, align 4, !taffo.info !44
  %58 = add nsw i32 %57, 1, !taffo.info !35
...
; <label>:60:                                     ; preds = %78, %59
  %61 = load i32, i32* %12, align 4, !taffo.info !44
  %62 = icmp slt i32 %61, 16, !taffo.info !12
  br i1 %62, label %63, label %81

; <label>:63:                                     ; preds = %60
  %64 = load i32, i32* %12, align 4, !taffo.info !44
  %65 = sext i32 %64 to i64, !taffo.info !37
  ...
  %70 = load i32, i32* %12, align 4, !taffo.info !44
  %71 = sext i32 %70 to i64, !taffo.info !37
  %72 = getelementptr inbounds float, float* %23, i64 %71, !taffo.info !12
  %73 = load float, float* %72, align 4, !taffo.info !12
  %74 = load float, float* %16, align 4, !taffo.info !52
  %75 = fmul float %73, %74, !taffo.info !52
  %76 = fpext float %75 to double, !taffo.info !52
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), double %76)
  br label %78

; <label>:78:                                     ; preds = %63
  %79 = load i32, i32* %12, align 4, !taffo.info !44
  %80 = add nsw i32 %79, 1, !taffo.info !42
...
; <label>:81:                                     ; preds = %60
  ...
  %83 = load i32, i32* %3, align 4, !taffo.info !50
  ret i32 %83, !taffo.info !50
}
