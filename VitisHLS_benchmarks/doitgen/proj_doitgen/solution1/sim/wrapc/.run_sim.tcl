...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "doitgen.autotvin.dat"
	set constFileTvOut       "doitgen.autotvout.dat"
	set constFileHdlTvIn     "doitgen.autohdltvin.dat"
	set constFileHdlTvOut    "doitgen.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
