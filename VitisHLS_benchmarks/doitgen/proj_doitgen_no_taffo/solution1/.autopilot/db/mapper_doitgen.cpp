...
using hls::sim::Byte;
extern "C" void doitgen(Byte<4>*, Byte<4>*, int, Byte<4>*, Byte<4>*, Byte<4>*, int, Byte<4>*, Byte<4>*, Byte<4>*, int);
extern "C" void apatb_doitgen_hw(volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_A_2, volatile void * __xlx_apatb_param_A_3, volatile void * __xlx_apatb_param_C_0, volatile void * __xlx_apatb_param_C_1, volatile void * __xlx_apatb_param_C_2, volatile void * __xlx_apatb_param_C_3, volatile void * __xlx_apatb_param_sum) {
using hls::sim::createStream;
  // Collect __xlx_A_0_C_0__tmp_vec
std::vector<Byte<4>> __xlx_A_0_C_0__tmp_vec;
for (size_t i = 0; i < 1024; ++i){
__xlx_A_0_C_0__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_A_0)[i]);
}
  int __xlx_size_param_A_0 = 1024;
  int __xlx_offset_param_A_0 = 0;
  int __xlx_offset_byte_param_A_0 = 0*4;
for (size_t i = 0; i < 64; ++i){
__xlx_A_0_C_0__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_C_0)[i]);
}
  int __xlx_size_param_C_0 = 64;
  int __xlx_offset_param_C_0 = 1024;
  int __xlx_offset_byte_param_C_0 = 1024*4;
...
__xlx_C_3__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_C_3)[i]);
  ...
  int __xlx_size_param_C_3 = 64;
  int __xlx_offset_param_C_3 = 0;
  int __xlx_offset_byte_param_C_3 = 0*4;
  // DUT call
  doitgen(__xlx_A_0_C_0__tmp_vec.data(), __xlx_sum__tmp_vec.data(), __xlx_offset_byte_param_A_0, __xlx_A_1__tmp_vec.data(), __xlx_A_2__tmp_vec.data(), __xlx_A_3__tmp_vec.data(), __xlx_offset_byte_param_C_0, __xlx_C_1__tmp_vec.data(), __xlx_C_2__tmp_vec.data(), __xlx_C_3__tmp_vec.data(), __xlx_offset_byte_param_sum);
// print __xlx_apatb_param_A_0
for (size_t i = 0; i < __xlx_size_param_A_0; ++i) {
((Byte<4>*)__xlx_apatb_param_A_0)[i] = __xlx_A_0_C_0__tmp_vec[__xlx_offset_param_A_0+i];
}
// print __xlx_apatb_param_C_0
for (size_t i = 0; i < __xlx_size_param_C_0; ++i) {
((Byte<4>*)__xlx_apatb_param_C_0)[i] = __xlx_A_0_C_0__tmp_vec[__xlx_offset_param_C_0+i];
}
