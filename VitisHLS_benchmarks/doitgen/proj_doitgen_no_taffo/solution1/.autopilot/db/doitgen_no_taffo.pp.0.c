...
# 2 "<built-in>" 2
# 1 "doitgen_no_taffo.c" 2
# 12 "doitgen_no_taffo.c"
...
{
#line 15 "/home/bruno/Desktop/benchmarks/doitgen/proj_doitgen_no_taffo/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=doitgen
# 25 "doitgen_no_taffo.c"

#line 6 "/home/bruno/Desktop/benchmarks/doitgen/proj_doitgen_no_taffo/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=doitgen
# 25 "doitgen_no_taffo.c"
...
int main(int argc, char** argv)
{
  ...
  VITIS_LOOP_110_6: for (i = 0; i < nr*nq*np; i++)
   {
    printf("%f \n", A[i]);
   }
  return 0;
