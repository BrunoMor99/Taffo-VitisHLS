...
//------------------------Parameter----------------------
localparam
    ADDR_A_0_DATA_0 = 6'h10,
    ADDR_A_0_DATA_1 = 6'h14,
    ADDR_A_0_CTRL   = 6'h18,
    ADDR_C_0_DATA_0 = 6'h1c,
    ADDR_C_0_DATA_1 = 6'h20,
    ADDR_C_0_CTRL   = 6'h24,
    ADDR_SUM_DATA_0 = 6'h28,
    ADDR_SUM_DATA_1 = 6'h2c,
    ADDR_SUM_CTRL   = 6'h30,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SUM_DATA_1)
            int_sum[63:32] <= (WDATA[31:0] & wmask) | (int_sum[63:32] & ~wmask);
    end
end
