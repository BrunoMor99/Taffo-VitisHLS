...
set C_modelArgList {
	{ path float 32 regular {array 256 { 2 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
}
...
set portList { 
	...
	{ path_address1 sc_out sc_lv 8 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_2_full_dsp_1_U13", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_1_no_dsp_1_U14", "Parent" : "0"},
...
set Spec2ImplPortList { 
	path { ap_memory {  { path_address0 mem_address 1 8 }  { path_ce0 mem_ce 1 1 }  { path_we0 mem_we 1 1 }  { path_d0 mem_din 1 32 }  { path_q0 mem_dout 0 32 }  { path_address1 MemPortADDR2 1 8 }  { path_ce1 MemPortCE2 1 1 }  { path_q1 MemPortDOUT2 0 32 } } }
}
