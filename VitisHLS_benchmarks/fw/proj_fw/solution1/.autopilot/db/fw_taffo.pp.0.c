...
__attribute__((sdx_kernel("fw", 0))) void fw(){
#line 55 "/home/bruno/Desktop/benchmarks/fw/run_hls_1.tcl"
#pragma HLSDIRECTIVE TOP name=fw
# 21 "fw_taffo.c"
  ...
  VITIS_LOOP_30_1: for (i = 0; i < n; i++){
    VITIS_LOOP_31_2: for (j = 0; j < n; j++) {
      path[i*n+j] = i*j%7+1;
  ...
  VITIS_LOOP_38_3: for (k = 0; k < 16; k++){
      VITIS_LOOP_39_4: for(i = 0; i < 16; i++){
        VITIS_LOOP_40_5: for (j = 0; j < 16; j++) {
  ...
  VITIS_LOOP_53_6: for (i = 0; i < 16*16; i++){
    printf("%f \n", path[i]);
  }
