; ModuleID = '/home/bruno/Desktop/benchmarks/fw/intermediate/output.4.magiclangtmp.ll'
...
entry:
  ...
  %path.s12_20fixp = alloca [256 x i32], align 4, !taffo.info !30, !taffo.target !33
  %tmpa.s11_21fixp = alloca i32, align 4, !taffo.info !34
  %tmpb.s11_21fixp = alloca i32, align 4, !taffo.info !34
  ...
  %4 = bitcast [256 x i32]* %path.s12_20fixp to i8*, !dbg !53, !taffo.info !54, !taffo.target !33
  %5 = bitcast i8* %4 to i8*, !taffo.info !54, !taffo.target !33
  call void @llvm.lifetime.start.p0i8(i64 1024, i8* %5) #3, !dbg !53, !taffo.info !44, !taffo.target !33
  call void @llvm.dbg.declare(metadata !13, metadata !55, metadata !DIExpression()), !dbg !60
...
for.cond:                                         ; preds = %for.inc27, %VITIS_LOOP_30_1
  %6 = load i32, i32* %i, align 4, !dbg !64, !taffo.info !66
  %7 = load i32, i32* %n, align 4, !dbg !68, !taffo.info !26
  %cmp = icmp slt i32 %6, %7, !dbg !69, !taffo.info !70
...
for.cond5:                                        ; preds = %for.inc, %VITIS_LOOP_31_2
  %8 = load i32, i32* %j, align 4, !dbg !77, !taffo.info !79
  %9 = load i32, i32* %n, align 4, !dbg !81, !taffo.info !26
  %cmp6 = icmp slt i32 %8, %9, !dbg !82, !taffo.info !70
  br i1 %cmp6, label %for.body7, label %for.end, !dbg !83, !taffo.info !44

for.body7:                                        ; preds = %for.cond5
  %10 = load i32, i32* %i, align 4, !dbg !84, !taffo.info !28
  %11 = load i32, i32* %j, align 4, !dbg !86, !taffo.info !28
  %mul = mul nsw i32 %10, %11, !dbg !87, !taffo.info !88
  %rem = srem i32 %mul, 7, !dbg !90, !taffo.info !91
  %add = add nsw i32 %rem, 1, !dbg !93, !taffo.info !94
  %conv.s5_27fixp = shl i32 %add, 27, !dbg !84, !taffo.info !96
  %12 = ashr i32 %conv.s5_27fixp, 7, !dbg !84, !taffo.info !96
  %13 = load i32, i32* %i, align 4, !dbg !98, !taffo.info !28
  %14 = load i32, i32* %n, align 4, !dbg !99, !taffo.info !26
  %mul8 = mul nsw i32 %13, %14, !dbg !100, !taffo.info !88
  %15 = load i32, i32* %j, align 4, !dbg !101, !taffo.info !28
  %add9 = add nsw i32 %mul8, %15, !dbg !102, !taffo.info !103
  %idxprom = sext i32 %add9 to i64, !dbg !105, !taffo.info !103
  %arrayidx.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom, !dbg !105, !taffo.info !30, !taffo.target !33
  store i32 %12, i32* %arrayidx.s12_20fixp, align 4, !dbg !106, !taffo.info !44, !taffo.target !33
  %16 = load i32, i32* %i, align 4, !dbg !107, !taffo.info !28
  %17 = load i32, i32* %j, align 4, !dbg !109, !taffo.info !28
  %add10 = add nsw i32 %16, %17, !dbg !110, !taffo.info !111
...
lor.lhs.false:                                    ; preds = %for.body7
  %18 = load i32, i32* %i, align 4, !dbg !118, !taffo.info !66
  %19 = load i32, i32* %j, align 4, !dbg !119, !taffo.info !66
  %add14 = add nsw i32 %18, %19, !dbg !120, !taffo.info !121
...
lor.lhs.false18:                                  ; preds = %lor.lhs.false
  %20 = load i32, i32* %i, align 4, !dbg !126, !taffo.info !66
  %21 = load i32, i32* %j, align 4, !dbg !127, !taffo.info !66
  %add19 = add nsw i32 %20, %21, !dbg !128, !taffo.info !121
...
if.then:                                          ; preds = %lor.lhs.false18, %lor.lhs.false, %for.body7
  %22 = load i32, i32* %i, align 4, !dbg !134, !taffo.info !28
  %23 = load i32, i32* %n, align 4, !dbg !135, !taffo.info !26
  %mul23 = mul nsw i32 %22, %23, !dbg !136, !taffo.info !88
  %24 = load i32, i32* %j, align 4, !dbg !137, !taffo.info !28
  %add24 = add nsw i32 %mul23, %24, !dbg !138, !taffo.info !103
  %idxprom25 = sext i32 %add24 to i64, !dbg !139, !taffo.info !103
  %arrayidx26.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom25, !dbg !139, !taffo.info !30, !taffo.target !33
  store i32 1047527424, i32* %arrayidx26.s12_20fixp, align 4, !dbg !140, !taffo.info !44, !taffo.target !33
...
for.inc:                                          ; preds = %if.end
  %25 = load i32, i32* %j, align 4, !dbg !142, !taffo.info !66
  %inc = add nsw i32 %25, 1, !dbg !142, !taffo.info !143
...
for.inc27:                                        ; preds = %for.end
  %26 = load i32, i32* %i, align 4, !dbg !150, !taffo.info !28
  %inc28 = add nsw i32 %26, 1, !dbg !150, !taffo.info !151
...
for.cond30:                                       ; preds = %for.inc85, %VITIS_LOOP_38_3
  %27 = load i32, i32* %k, align 4, !dbg !160, !taffo.info !66
  %cmp31 = icmp slt i32 %27, 16, !dbg !162, !taffo.info !70
...
for.cond33:                                       ; preds = %for.inc82, %VITIS_LOOP_39_4
  %28 = load i32, i32* %i, align 4, !dbg !169, !taffo.info !66
  %cmp34 = icmp slt i32 %28, 16, !dbg !171, !taffo.info !70
...
for.cond36:                                       ; preds = %for.inc79, %VITIS_LOOP_40_5
  %29 = load i32, i32* %j, align 4, !dbg !178, !taffo.info !79
  %cmp37 = icmp slt i32 %29, 16, !dbg !180, !taffo.info !70
  br i1 %cmp37, label %for.body38, label %for.end81, !dbg !181, !taffo.info !44

for.body38:                                       ; preds = %for.cond36
  %30 = bitcast i32* %tmpa.s11_21fixp to i8*, !dbg !182, !taffo.info !184
  %31 = bitcast i8* %30 to i8*, !taffo.info !184
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %31) #3, !dbg !182, !taffo.info !44
  call void @llvm.dbg.declare(metadata !13, metadata !185, metadata !DIExpression()), !dbg !186
  %32 = load i32, i32* %i, align 4, !dbg !187, !taffo.info !66
  %33 = load i32, i32* %n, align 4, !dbg !188, !taffo.info !26
  %mul40 = mul nsw i32 %32, %33, !dbg !189, !taffo.info !190
  %34 = load i32, i32* %k, align 4, !dbg !192, !taffo.info !66
  %add41 = add nsw i32 %mul40, %34, !dbg !193, !taffo.info !194
  %idxprom42 = sext i32 %add41 to i64, !dbg !196, !taffo.info !194
  %arrayidx43.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom42, !dbg !196, !taffo.info !30, !taffo.target !33
  %s12_20fixp7 = load i32, i32* %arrayidx43.s12_20fixp, align 4, !dbg !196, !taffo.info !30, !taffo.target !33
  %35 = shl i32 %s12_20fixp7, 1, !dbg !186, !taffo.info !30, !taffo.target !33
  store i32 %35, i32* %tmpa.s11_21fixp, align 4, !dbg !186, !taffo.info !44
  %36 = bitcast i32* %tmpb.s11_21fixp to i8*, !dbg !197, !taffo.info !184
  %37 = bitcast i8* %36 to i8*, !taffo.info !184
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %37) #3, !dbg !197, !taffo.info !44
  call void @llvm.dbg.declare(metadata !13, metadata !198, metadata !DIExpression()), !dbg !199
  %38 = load i32, i32* %k, align 4, !dbg !200, !taffo.info !66
  %39 = load i32, i32* %n, align 4, !dbg !201, !taffo.info !26
  %mul45 = mul nsw i32 %38, %39, !dbg !202, !taffo.info !190
  %40 = load i32, i32* %j, align 4, !dbg !203, !taffo.info !28
  %add46 = add nsw i32 %mul45, %40, !dbg !204, !taffo.info !205
  %idxprom47 = sext i32 %add46 to i64, !dbg !207, !taffo.info !205
  %arrayidx48.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom47, !dbg !207, !taffo.info !30, !taffo.target !33
  %s12_20fixp6 = load i32, i32* %arrayidx48.s12_20fixp, align 4, !dbg !207, !taffo.info !30, !taffo.target !33
  %41 = shl i32 %s12_20fixp6, 1, !dbg !199, !taffo.info !30, !taffo.target !33
  store i32 %41, i32* %tmpb.s11_21fixp, align 4, !dbg !199, !taffo.info !44
  %42 = bitcast i32* %cond to i8*, !dbg !208
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %42) #3, !dbg !208
  call void @llvm.dbg.declare(metadata i32* %cond, metadata !209, metadata !DIExpression()), !dbg !210
  %43 = load i32, i32* %i, align 4, !dbg !211, !taffo.info !66
  %44 = load i32, i32* %n, align 4, !dbg !212, !taffo.info !26
  %mul49 = mul nsw i32 %43, %44, !dbg !213, !taffo.info !190
  %45 = load i32, i32* %j, align 4, !dbg !214, !taffo.info !28
  %add50 = add nsw i32 %mul49, %45, !dbg !215, !taffo.info !205
  %idxprom51 = sext i32 %add50 to i64, !dbg !216, !taffo.info !205
  %arrayidx52.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom51, !dbg !216, !taffo.info !30, !taffo.target !33
  %s12_20fixp5 = load i32, i32* %arrayidx52.s12_20fixp, align 4, !dbg !216, !taffo.info !30, !taffo.target !33
  %46 = load i32, i32* %i, align 4, !dbg !217, !taffo.info !66
  %47 = load i32, i32* %n, align 4, !dbg !218, !taffo.info !26
  %mul53 = mul nsw i32 %46, %47, !dbg !219, !taffo.info !190
  %48 = load i32, i32* %k, align 4, !dbg !220, !taffo.info !66
  %add54 = add nsw i32 %mul53, %48, !dbg !221, !taffo.info !194
  %idxprom55 = sext i32 %add54 to i64, !dbg !222, !taffo.info !194
  %arrayidx56.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom55, !dbg !222, !taffo.info !30, !taffo.target !33
  %s12_20fixp4 = load i32, i32* %arrayidx56.s12_20fixp, align 4, !dbg !222, !taffo.info !30, !taffo.target !33
  %49 = load i32, i32* %k, align 4, !dbg !223, !taffo.info !66
  %50 = load i32, i32* %n, align 4, !dbg !224, !taffo.info !26
  %mul57 = mul nsw i32 %49, %50, !dbg !225, !taffo.info !190
  %51 = load i32, i32* %j, align 4, !dbg !226, !taffo.info !28
  %add58 = add nsw i32 %mul57, %51, !dbg !227, !taffo.info !205
  %idxprom59 = sext i32 %add58 to i64, !dbg !228, !taffo.info !205
  %arrayidx60.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom59, !dbg !228, !taffo.info !30, !taffo.target !33
  %s12_20fixp3 = load i32, i32* %arrayidx60.s12_20fixp, align 4, !dbg !228, !taffo.info !30, !taffo.target !33
  %add61.s12_20fixp = add i32 %s12_20fixp4, %s12_20fixp3, !dbg !229, !taffo.info !230, !taffo.target !33
  %52 = icmp slt i32 %s12_20fixp5, %add61.s12_20fixp, !dbg !232, !taffo.info !54, !taffo.target !33
  %conv63.flt = zext i1 %52 to i32, !dbg !216, !taffo.info !54, !taffo.target !33
  store i32 %conv63.flt, i32* %cond, align 4, !dbg !210, !taffo.info !44, !taffo.target !33
  %53 = load i32, i32* %cond, align 4, !dbg !233, !taffo.info !37
  %tobool = icmp ne i32 %53, 0, !dbg !233, !taffo.info !37
  br i1 %tobool, label %if.then64, label %if.else, !dbg !235

if.then64:                                        ; preds = %for.body38
  %54 = load i32, i32* %i, align 4, !dbg !236, !taffo.info !66
  %55 = load i32, i32* %n, align 4, !dbg !238, !taffo.info !26
  %mul65 = mul nsw i32 %54, %55, !dbg !239, !taffo.info !190
  %56 = load i32, i32* %j, align 4, !dbg !240, !taffo.info !66
  %add66 = add nsw i32 %mul65, %56, !dbg !241, !taffo.info !194
  %idxprom67 = sext i32 %add66 to i64, !dbg !242, !taffo.info !194
  %arrayidx68.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom67, !dbg !242, !taffo.info !30, !taffo.target !33
  %s12_20fixp2 = load i32, i32* %arrayidx68.s12_20fixp, align 4, !dbg !242, !taffo.info !30, !taffo.target !33
  %57 = load i32, i32* %i, align 4, !dbg !243, !taffo.info !66
  %58 = load i32, i32* %n, align 4, !dbg !244, !taffo.info !26
  %mul69 = mul nsw i32 %57, %58, !dbg !245, !taffo.info !190
  %59 = load i32, i32* %j, align 4, !dbg !246, !taffo.info !66
  %add70 = add nsw i32 %mul69, %59, !dbg !247, !taffo.info !194
  %idxprom71 = sext i32 %add70 to i64, !dbg !248, !taffo.info !194
  %arrayidx72.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom71, !dbg !248, !taffo.info !30, !taffo.target !33
  store i32 %s12_20fixp2, i32* %arrayidx72.s12_20fixp, align 4, !dbg !249, !taffo.info !44, !taffo.target !33
  br label %if.end78, !dbg !250

if.else:                                          ; preds = %for.body38
  %s11_21fixp = load i32, i32* %tmpa.s11_21fixp, align 4, !dbg !251, !taffo.info !253
  %60 = ashr i32 %s11_21fixp, 1, !dbg !254, !taffo.info !253
  %s11_21fixp1 = load i32, i32* %tmpb.s11_21fixp, align 4, !dbg !254, !taffo.info !253
  %61 = ashr i32 %s11_21fixp1, 1, !dbg !255, !taffo.info !253
  %add73.s12_20fixp = add i32 %60, %61, !dbg !255, !taffo.info !230
  %62 = load i32, i32* %i, align 4, !dbg !256, !taffo.info !66
  %63 = load i32, i32* %n, align 4, !dbg !257, !taffo.info !26
  %mul74 = mul nsw i32 %62, %63, !dbg !258, !taffo.info !190
  %64 = load i32, i32* %j, align 4, !dbg !259, !taffo.info !28
  %add75 = add nsw i32 %mul74, %64, !dbg !260, !taffo.info !205
  %idxprom76 = sext i32 %add75 to i64, !dbg !261, !taffo.info !205
  %arrayidx77.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom76, !dbg !261, !taffo.info !30, !taffo.target !33
  store i32 %add73.s12_20fixp, i32* %arrayidx77.s12_20fixp, align 4, !dbg !262, !taffo.info !44, !taffo.target !33
  br label %if.end78

if.end78:                                         ; preds = %if.else, %if.then64
  %65 = bitcast i32* %cond to i8*, !dbg !263, !taffo.info !37
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %65) #3, !dbg !263
  %66 = bitcast i32* %tmpb.s11_21fixp to i8*, !dbg !263, !taffo.info !184
  %67 = bitcast i8* %66 to i8*, !taffo.info !184
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %67) #3, !dbg !263, !taffo.info !44
  %68 = bitcast i32* %tmpa.s11_21fixp to i8*, !dbg !263, !taffo.info !184
  %69 = bitcast i8* %68 to i8*, !taffo.info !184
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %69) #3, !dbg !263, !taffo.info !44
  br label %for.inc79, !dbg !264

for.inc79:                                        ; preds = %if.end78
  %70 = load i32, i32* %j, align 4, !dbg !265, !taffo.info !66
  %inc80 = add nsw i32 %70, 1, !dbg !265, !taffo.info !143
...
for.inc82:                                        ; preds = %for.end81
  %71 = load i32, i32* %i, align 4, !dbg !271, !taffo.info !28
  %inc83 = add nsw i32 %71, 1, !dbg !271, !taffo.info !151
...
for.inc85:                                        ; preds = %for.end84
  %72 = load i32, i32* %k, align 4, !dbg !277, !taffo.info !28
  %inc86 = add nsw i32 %72, 1, !dbg !277, !taffo.info !151
...
for.cond88:                                       ; preds = %for.inc94, %VITIS_LOOP_53_6
  %73 = load i32, i32* %i, align 4, !dbg !285, !taffo.info !66
  %cmp89 = icmp slt i32 %73, 256, !dbg !287, !taffo.info !288
  br i1 %cmp89, label %for.body90, label %for.end96, !dbg !290, !taffo.info !44

for.body90:                                       ; preds = %for.cond88
  %74 = load i32, i32* %i, align 4, !dbg !291, !taffo.info !28
  %idxprom91 = sext i32 %74 to i64, !dbg !293, !taffo.info !28
  %arrayidx92.s12_20fixp = getelementptr inbounds [256 x i32], [256 x i32]* %path.s12_20fixp, i64 0, i64 %idxprom91, !dbg !293, !taffo.info !30, !taffo.target !33
  %s12_20fixp.s12_20fixp = load i32, i32* %arrayidx92.s12_20fixp, align 4, !dbg !293, !taffo.info !30, !taffo.target !33
  %75 = sitofp i32 %s12_20fixp.s12_20fixp to double, !dbg !293, !taffo.info !30, !taffo.target !33
  %76 = fdiv double %75, 0x4130000000000000, !dbg !293, !taffo.info !30, !taffo.target !33
  %call.flt = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), double %76), !dbg !294, !taffo.info !54, !taffo.target !33
  br label %for.inc94, !dbg !295

for.inc94:                                        ; preds = %for.body90
  %77 = load i32, i32* %i, align 4, !dbg !296, !taffo.info !28
  %inc95 = add nsw i32 %77, 1, !dbg !296, !taffo.info !151
  store i32 %inc95, i32* %i, align 4, !dbg !296, !taffo.info !44
  br label %for.cond88, !dbg !297, !llvm.loop !298

for.end96:                                        ; preds = %for.cond88
  %78 = bitcast [256 x i32]* %path.s12_20fixp to i8*, !dbg !301, !taffo.info !54, !taffo.target !33
  %79 = bitcast i8* %78 to i8*, !taffo.info !54, !taffo.target !33
  call void @llvm.lifetime.end.p0i8(i64 1024, i8* %79) #3, !dbg !301, !taffo.info !44, !taffo.target !33
  %80 = bitcast i32* %k to i8*, !dbg !301, !taffo.info !28
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %80) #3, !dbg !301, !taffo.info !44
  %81 = bitcast i32* %j to i8*, !dbg !301, !taffo.info !28
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %81) #3, !dbg !301, !taffo.info !44
  %82 = bitcast i32* %i to i8*, !dbg !301, !taffo.info !28
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %82) #3, !dbg !301, !taffo.info !44
  %83 = bitcast i32* %n to i8*, !dbg !301, !taffo.info !26
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %83) #3, !dbg !301
  ret void, !dbg !301
}
