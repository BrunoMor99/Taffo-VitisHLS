...
#define AUTOTB_TVOUT_gamma "../tv/cdatafile/c.mm.autotvout_gamma.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.mm.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.mm.autotvout_ap_return.dat"
...
extern "C"
float mm_hw_stub_wrapper(float);

extern "C"
float apatb_mm_hw(float __xlx_apatb_param_gamma)
{
  float ap_return;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gamma),
#endif
  };
  port1.param = &__xlx_apatb_param_gamma;
  ...
  try {
    ...
    ap_return = mm_hw_stub_wrapper(__xlx_apatb_param_gamma);
