...
`define AUTOTB_DUT      atax
`define AUTOTB_DUT_INST AESL_inst_atax
`define AUTOTB_TOP      apatb_atax_top
`define AUTOTB_LAT_RESULT_FILE "atax.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "atax.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_atax_top
...
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.atax.autotvin_gmem.dat"
`define AUTOTB_TVIN_A  "../tv/cdatafile/c.atax.autotvin_A.dat"
`define AUTOTB_TVIN_x  "../tv/cdatafile/c.atax.autotvin_x.dat"
`define AUTOTB_TVIN_y  "../tv/cdatafile/c.atax.autotvin_y.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.atax.autotvin_gmem.dat"
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.atax.autotvin_A.dat"
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.atax.autotvin_x.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.atax.autotvin_y.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.atax.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.atax.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 359;
parameter LENGTH_A = 1;
parameter LENGTH_gmem = 288;
