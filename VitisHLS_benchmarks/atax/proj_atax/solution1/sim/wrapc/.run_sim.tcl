...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "atax.autotvin.dat"
	set constFileTvOut       "atax.autotvout.dat"
	set constFileHdlTvIn     "atax.autohdltvin.dat"
	set constFileHdlTvOut    "atax.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
