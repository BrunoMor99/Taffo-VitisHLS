...
architecture behave of mm3_control_s_axi is
    ...
    constant ADDR_D_DATA_0 : INTEGER := 16#34#;
    constant ADDR_D_DATA_1 : INTEGER := 16#38#;
    constant ADDR_D_CTRL   : INTEGER := 16#3c#;
    constant ADDR_E_DATA_0 : INTEGER := 16#40#;
    constant ADDR_E_DATA_1 : INTEGER := 16#44#;
    constant ADDR_E_CTRL   : INTEGER := 16#48#;
    constant ADDR_F_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_F_DATA_1 : INTEGER := 16#50#;
    constant ADDR_F_CTRL   : INTEGER := 16#54#;
    constant ADDR_G_DATA_0 : INTEGER := 16#58#;
    constant ADDR_G_DATA_1 : INTEGER := 16#5c#;
    constant ADDR_G_CTRL   : INTEGER := 16#60#;
    ...
    signal int_D               : UNSIGNED(63 downto 0) := (others => '0');
    signal int_E               : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_E_DATA_1 =>
                        rdata_data <= RESIZE(int_E(63 downto 32), 32);
                    when ADDR_F_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_E_DATA_1) then
                    int_E(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_E(63 downto 32));
                end if;
            end if;
        end if;
    end process;
