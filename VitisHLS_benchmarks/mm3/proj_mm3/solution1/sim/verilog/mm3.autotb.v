...
`define AUTOTB_DUT      mm3
`define AUTOTB_DUT_INST AESL_inst_mm3
`define AUTOTB_TOP      apatb_mm3_top
`define AUTOTB_LAT_RESULT_FILE "mm3.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mm3.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mm3_top
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_gmem.dat"
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_C.dat"
`define AUTOTB_TVIN_D_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_D.dat"
`define AUTOTB_TVIN_E_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_E.dat"
`define AUTOTB_TVIN_F_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_F.dat"
`define AUTOTB_TVIN_G_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvin_G.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.mm3.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.mm3.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 35339;
